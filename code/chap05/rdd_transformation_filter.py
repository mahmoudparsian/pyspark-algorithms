...
if __name__ == '__main__':
    ...
    #if len(sys.argv) != 2:  
    #    print("Usage: rdd_transformation_filter.py <file>", file=sys.stderr)
    #    exit(-1)

    # create an instance of SparkSession
    spark = SparkSession\
        .builder\
        .appName("rdd_transformation_filter")\
        .getOrCreate()
    #
    print("spark=",  spark)
    ...
    list_of_tuples= [('alex','Sunnyvale', 25), ('alex','Sunnyvale', 33), ('mary', 'Ames', 22), ('mary', 'Cupertino', 66), ('jane', 'Ames', 20), ('bob', 'Ames', 26)]
